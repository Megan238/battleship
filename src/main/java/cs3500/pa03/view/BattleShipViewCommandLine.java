 ...
 */
public class BattleShipViewCommandLine implements BattleShipView {
  private final Scanner input;
  private final Appendable output;


  public BattleShipViewCommandLine(Readable input, Appendable output) {
  ...
  public int[] askSize(String prompt) throws IOException {
    ...
    while (true) {
      ...
      try {
        ...
        this.output.append("Please enter two integers : ");
      }
    }
  }
